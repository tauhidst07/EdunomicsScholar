    ...
    <div>
      ...
      <div className="main-tog">
        <div className="mid-tog">
          <button className="aw-bt" onClick={onToggle}>
            Create an Award
          </button>
      ...
      <div className="define-block">
        ...
        <div className="define-head">
          ...
          <p>
            Creating an award on Bold.org is easy. You tell us what you want.
          ...
          <p style={{ marginTop: ".6rem" }}>
            ...
            over what applicants submit, and how involved you want to be in the
            process.
          </p>
        </div>
      </div>
      <div className="define-block">
        ...
        <div className="define-head">
          ...
          <p>
            ...
            <span style={{ font: "bold", fontWeight: "700" }}>
              we'll review all the applications and mark the best ones for you.
            </span>
          </p>
          <br />
          <p>
            Of the hundreds who will apply, we’ll indicate the top 10-20 who are
            the closest fit.
          </p>
        </div>
      </div>
