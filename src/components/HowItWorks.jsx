    ...
    <div>
      ...
      <div>
        <div className="define-block">
          ...
          <div className="define-head">
            ...
            <p>
              Creating an award on Edunomics is easy. You tell us what you want.
      ...
      <div>
        <div className="define-block">
          ...
          <div className="define-head">
            <h1>
              1. Select an existing award on Edunomics you’d like to help fund.
            </h1>
            <p>
              With scholarships, fellowships, and grants across dozens of focus
              areas, selecting an award that resonates is easy.
            </p>
          </div>
        </div>
        <div className="define-block">
