...
const MyApplications = () => {
  ...
  let myId = jwt.decode(encodedToken)?._id;

  // const [loading, setLoading] = useState(true);
  // const [error, setError] = useState("");
  const [data, setData] = useState(null);
  console.log("myappli: ", myAppli);
  ...
  const [selected, setSelected] = useState("all");  
   ...
   const filtered = useMemo(() => { 
    if(myAppli && selected==="all"){
      return myAppli.scholarships
    }
    const myApplications = myAppli?.scholarships?.filter((schol) =>
      schol.applicants?.some((app) => app.applicant === myId && app.status===selected)
    ); 
    ...
    <div className="myApplication">
      ...
      {loader ? (
        ...
        <div className="myApplication__main">
          ...
          {filtered?.map((item) => (
            <div className="myApplication__main__scholarships" key={item._id}>
