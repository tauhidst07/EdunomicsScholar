...
function Dashboard() {
  ...
  useEffect(() => {
      axios
        .get('https://rishabhsingh.herokuapp.com/api/user/profile/605c63ee7e97f30017ca6456')
        .then(res => {
          setLoading(false)
          setData(res.data)
          setError('')
    ...
    <div className="dashboard">
      ...
      <div className="dashboard__body">
        <div className="userInfo">
          <div className="left">
            <div>
              <img className="profileImg" src={profile} alt="profile" width="70" />
            ...
            <div className="userEarningPoints">
              <a href="/">
                <img alt="earning points" src="https://bld-schl-pcs.s3.us-east-2.amazonaws.com/bold-scholarship-300.jpeg" />
              </a>
              <div>
                <div>
                  Earn
                  <span>50</span> more Bold Points to unlock<br /> a new $2,000 scholarship
                </div>
