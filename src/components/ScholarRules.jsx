  ...
  return (
    <div>
      ...
      <div className="sch-top">
        ...
        <p>
          The pride.edunomics.in Terms of Use, Privacy Policy and any additional terms and
          conditions listed as applicable to a particular scholarship shall be
          deemed an integral part of these Official Scholarship Rules. pride.edunomics.in
        ...
        <p style={{ marginTop: "1rem" }}>
          ...
          officer, director, member or employee of pride.edunomics.in or any other party
          ...
          of any of these individuals, whether or not related. Further, pride.edunomics.in
        ...
        <p>
          ...
          application through the pride.edunomics.in platform by the application deadline,
          and agree to be bound by these Official Scholarship Rules. pride.edunomics.in
          expressly reserves the right to disqualify any applicant and/or
          applications that are inaccurate, incomplete, or that pride.edunomics.in
        ...
        <p>
          ...
          pride.edunomics.in or the scholarship provider to determine the winner of each
          ...
          binding in all respects. pride.edunomics.in reserves the right not to award a
        ...
        <p>
          ...
          pride.edunomics.in during the application process. Scholarship recipients may be
          ...
          that you provide may be verified, pride.edunomics.in is not under any obligation
          ...
          alternate recipient at pride.edunomics.in’s sole discretion.
        </p>
        <p>
          <bold style={{ fontWeight: "bold" }}> Awarding.</bold>
          After successful notification of a scholarship award and verification,
          pride.edunomics.in will provide payment of the award to the scholarship winner’s
        ...
        <p style={{ marginBottom: "6rem" }}>
          ...
          pride.edunomics.in, its employees, representatives, agents, contractors,
          ...
          participation in the scholarship. pride.edunomics.in reserves the right to
          ...
          provisions shall remain in full force and effect. pride.edunomics.in is not
