  ...
  return (
    <div>
      ...
      <div className="sch-top">
        ...
        <p>
          The pride.edunomics.in Terms of Use, Privacy Policy and any additional
          ...
          pride.edunomics.in reserves the right to amend or discontinue
        ...
        <p style={{ marginTop: "1rem" }}>
          ...
          officer, director, member or employee of pride.edunomics.in or any
          ...
          Further, pride.edunomics.in reserves the right to disqualify any
        ...
        <p>
          ...
          application through the pride.edunomics.in platform by the application
          deadline, and agree to be bound by these Official Scholarship Rules.
          pride.edunomics.in expressly reserves the right to disqualify any
          applicant and/or applications that are inaccurate, incomplete, or that
          pride.edunomics.in believes in good faith to be generated by an
        ...
        <p>
          ...
          pride.edunomics.in or the scholarship provider to determine the winner
          ...
          final and binding in all respects. pride.edunomics.in reserves the
        ...
        <p>
          ...
          pride.edunomics.in during the application process. Scholarship
          ...
          pride.edunomics.in is not under any obligation to verify any of the
        ...
        <p style={{ marginBottom: "6rem" }}>
          ...
          pride.edunomics.in, its employees, representatives, agents,
          ...
          pride.edunomics.in reserves the right to modify or terminate
          ...
          full force and effect. pride.edunomics.in is not affiliated with,
